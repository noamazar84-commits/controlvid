...
export interface WhopApiCostBreakdown {
  shotstack: number;
  creatomate: number;
  elevenLabs: number;
  replicateSVD: number;
...
export interface WhopReconciliationReport {
  timestamp: string;
  totalWhopRevenue: number;
  totalApiUsageCost: number;
  netProfit: number;
  ...
  apiCostBreakdown: WhopApiCostBreakdown;
  userReconciliations: {
    userId: number;
    email: string;
    tier: string;
