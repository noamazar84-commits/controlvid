...
export default function LivePreview({ 
  ...
  const handleDownload = async () => {
    ...
    const fileContent = `
=========================================
CONTROLVID HIGH-RETENTION SCRIPT PACKAGE
=========================================
...
`;
    ...
    link.href = url;
    link.download = `${script.title.toLowerCase().replace(/[^a-z0-9]+/g, "_")}_controlvid_package.txt`;
  ...
  useEffect(() => {
    ...
    const loadOrchestratedMedia = async () => {
      ...
      try {
        ...
        const musicTheme = sessionStorage.getItem("wizard_selected_music_url") || sessionStorage.getItem("wizard_selected_music_theme") || undefined;
        const captionStyle = sessionStorage.getItem("wizard_selected_caption_style") || "ControlVid Blue";
  ...
  const handleShare = () => {
    ...
    if (navigator.clipboard) {
      navigator.clipboard.writeText("https://controlvid.ai/v/simulation");
    }
