...
export default function MagicMode({ onBack, onSuccess, modeType, isLoggedIn, onNavigatePricing, activeUser }: MagicModeProps) {
  ...
  const [voiceModel, setVoiceModel] = useState<string>('Adam (AI Male)'); // Voice options
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        {step === 'niche' && (
          <>
            ...
            {/* Input area */}
            <div style={{ width: '635px', display: 'flex', gap: '10px', boxSizing: 'border-box' }}>
              <input 
                type='text' 
              ...
              {(currentMatrix[selectedNiche] || [
                ...
                return (
                  <button 
                    ...
                    className={`sub-niche-card ${isSelected ? 'active' : ''}`}
                    style={{ 
                      background: '#16161a', 
                      border: isSelected ? '3px solid #FFFFFF' : '1px solid #333', 
                      borderRadius: '12px', 
