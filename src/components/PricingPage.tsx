...
export default function PricingPage({
  ...
  const [selectedPlanName, setSelectedPlanName] = useState<string>(initialPlanName || "Velocity");
  const [selectedAddOnKey, setSelectedAddOnKey] = useState<"starter_dm" | "pro_dm" | null>(null);
  ...
  const plans: Plan[] = [
    {
      ...
      monthlyPrice: 39,
      annualMonthlyRate: 35,
      videosCredits: "60 Credits/video/minutes - Viral/E-commerce/Long-form Video",
      annualVideosCredits: "720 Credits/year - Viral/E-commerce/Long-form Video",
      shadowChannels: 1,
      ...
      features: [
        "60 Credits/video/minutes - Viral/E-commerce/Long-form Video",
        "1 shadow_channel",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
        "Basic Analytics: Video Views Tracking",
        "DM Automation (Optional Add-on)",
        "Self-service support"
      ],
      annualFeatures: [
        "720 Credits/year - Viral/E-commerce/Long-form Video",
        "1 shadow_channel",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
        "Basic Analytics: Video Views Tracking",
    ...
    },
    {
      ...
      monthlyPrice: 79,
      annualMonthlyRate: 70,
      videosCredits: "120 Credits/video/minutes - Viral/E-commerce/Long-form Video",
      annualVideosCredits: "1,440 Credits/year - Viral/E-commerce/Long-form Video",
      shadowChannels: 4,
      ...
      features: [
        "120 Credits/video/minutes - Viral/E-commerce/Long-form Video",
        "4 shadow_channels",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
      ...
      annualFeatures: [
        "1,440 Credits/year - Viral/E-commerce/Long-form Video",
        "4 shadow_channels",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
        "Advanced Analytics: Retention & Drop-off",
    ...
    },
    {
      ...
      monthlyPrice: 119,
      annualMonthlyRate: 105,
      videosCredits: "190 Credits/video/minutes - Viral/E-commerce/Long-form Video",
      annualVideosCredits: "2,280 Credits/year - Viral/E-commerce/Long-form Video",
      shadowChannels: 5,
      ...
      features: [
        "190 Credits/video/minutes - Viral/E-commerce/Long-form Video",
        "5 shadow_channels",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
      ...
      annualFeatures: [
        "2,280 Credits/year - Viral/E-commerce/Long-form Video",
        "5 shadow_channels",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
        "Detailed Analytics: CTR & Conversions",
    ...
    },
    {
      ...
      monthlyPrice: 219,
      annualMonthlyRate: 200,
      videosCredits: "300 Credits/video/minutes - Viral/E-commerce/Long-form Video",
      annualVideosCredits: "3,600 Credits/year - Viral/E-commerce/Long-form Video",
      shadowChannels: 8,
      ...
      features: [
        "300 Credits/video/minutes - Viral/E-commerce/Long-form Video",
        "8 shadow_channels",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
      ...
      annualFeatures: [
        "3,600 Credits/year - Viral/E-commerce/Long-form Video",
        "8 shadow_channels",
        "Bulk Scheduler",
        "Bulk One-Click Generation & Posting",
        "Premium Analytics: Heatmaps & Performance",
  ...
  const addOns = {
    starter_dm: { name: "Starter DM Booster", price: 29, credits: 500, description: "Add 500 automated response credits to feed smaller campaigns" },
    pro_dm: { name: "Pro DM Booster", price: 129, credits: 3000, description: "Add 3,000 automated response credits built for massive viral loops" }
  };
  ...
  const handleCompleteCheckout = async () => {
    ...
    try {
      ...
      const trackedAffId = localStorage.getItem("viralflow_tracked_affiliate_id");
      if (trackedAffId) {
  ...
  return (
    <div id="pricing-plans-view" className="min-h-screen bg-[#121212] text-white flex flex-col justify-between py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden select-none">
      ...
      <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col items-center justify-center">
          ...
          <div className="w-full max-w-3xl mb-10 bg-red-500/10 border border-red-500/20 rounded-2xl p-4 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                You currently do not have an active subscription tier configured. Select one of our professional pricing plans below to proceed directly into the ViralFlow suite!
              </p>
            </div>
          </div>
        )}
        ...
        {successMessage ? (
          ...
          <>
            ...
            {/* CEO Backdoor Banner */}
            {adminBypassActive && isAdmin && (
              <div className="w-full max-w-3xl mb-10 bg-[#38bdf8]/10 border border-[#38bdf8]/30 rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-[0_0_30px_rgba(56, 189, 248, 0.1)]">
                <div className="flex items-center gap-4 text-center sm:text-left">
                  <div className="h-10 w-10 bg-[#38bdf8]/20 rounded-xl flex items-center justify-center border border-[#38bdf8]/30">
                    <Key className="h-5 w-5 text-[#38bdf8]" />
                  </div>
                  <div>
                    <h4 className="text-sm font-black font-mono text-[#38bdf8] uppercase tracking-wider">
                       CEO BACKDOOR ACTIVE
                    </h4>
                    <p className="text-xs text-slate-400 mt-0.5">
                      Direct bypass to ViralFlow workspace dashboard active.
                    </p>
                  </div>
                </div>
                <button
                  onClick={onCEOAccess}
                  className="w-full sm:w-auto px-6 py-2.5 bg-gradient-to-r from-[#38bdf8] to-[#00D2FF] text-white font-black font-sans text-xs tracking-widest rounded-xl hover:shadow-[0_0_20px_rgba(56, 189, 248, 0.4)] transition-all cursor-pointer hover:scale-[1.03] active:scale-[0.98]"
                >
              ...
              <div className="w-full max-w-4xl mx-auto text-center space-y-10">
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 bg-[#38bdf8]/10 border border-[#38bdf8]/20 px-3 py-1 rounded-full text-[10px] font-mono uppercase text-[#38bdf8] tracking-wider font-bold">
                    ⚡ STEP 2: SCALE-UP ADD-ON
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-black font-display text-white tracking-tight uppercase">
                    Optional DM Automation Credits
                  </h2>
                  <p className="text-xs text-slate-400 max-w-xl mx-auto font-sans leading-relaxed">
                    You have selected the <strong className="text-[#38bdf8]">{selectedPlan.name} Plan</strong>. Would you like to supercharge your conversion loops with optional one-time automated direct-message response credits?
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                  ...
                  >
                    ...
                    <div className="space-y-4 pt-4">
                      <span className="text-[9px] font-mono font-black text-slate-500 uppercase tracking-widest block">Starter Booster</span>
                      <h3 className="text-xl font-black font-display text-white uppercase tracking-tight">500 DM Credits</h3>
                  ...
                  >
                    ...
                    <div className="space-y-4 pt-4">
                      <span className="text-[9px] font-mono font-black text-slate-500 uppercase tracking-widest block">Pro Booster</span>
                      <h3 className="text-xl font-black font-display text-white uppercase tracking-tight">3000 DM Credits</h3>
                      <p className="text-xs text-slate-400 font-sans leading-normal">
      ...
      <footer className="w-full text-center mt-12 text-[10px] text-white font-mono tracking-wider uppercase">
        ViralFlow.ai © 2026. All Rights Reserved.
      </footer>
    </div>
  );
}
