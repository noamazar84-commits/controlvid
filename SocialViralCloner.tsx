...
export default function BentoShowcase({ 
  ...
  return (
    <section 
      ...
      className="relative z-10 py-4 sm:py-6 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#121212]"
    >
      ...
      <div className="py-2 w-full">
        <div 
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 w-full max-w-[1150px] mx-auto px-1"
        >
          {steps.map((button) => {
            ...
            return (
              ...
              >
                {/* Header Title Bar */}
                <div 
                  className="relative z-10 w-full min-w-0 shrink-0 flex items-center justify-center gap-2 mb-2.5 px-1"
                >
                  ...
                  <h3 
                    className="text-[10.5px] sm:text-[11px] font-black text-white uppercase tracking-tight font-mono truncate whitespace-nowrap min-w-0 shrink group-hover:text-[#38bdf8] transition-colors"
                  >
                    {button.title}
                  </h3>
                </div>
                ...
                <div 
                  className="relative w-full h-44 sm:h-48 rounded-xl overflow-hidden shrink-0 border border-cyan-400/50 group-hover:border-cyan-300 transition-colors shadow-lg"
                >
                  <img 
                    src={button.image} 
                    alt={button.title}
                ...
                {/* Massive Bold White Text Area */}
                <div 
                  className="relative z-10 flex-1 flex flex-col justify-center pt-3"
                >
