...
function Counter({ value, suffix = "" }: { value: number; suffix?: string }) {
  ...
  return (
    <span ref={ref} id={`counter-val-${value}`} className="whitespace-nowrap inline-block">
...
function SocialProofCounterSection() {
  return (
    <div className="relative z-10 w-full max-w-2xl mx-auto px-4 py-2.5 sm:py-4 flex items-center justify-center font-sans border-t border-white/[0.04]">
      <div className="flex items-center justify-center space-x-6 sm:space-x-16 w-full">
        {/* Column 1: Channels Automated */}
        <div className="flex flex-col items-center text-center shrink-0">
          <div className="text-2xl sm:text-4xl font-black text-white tracking-tight leading-none whitespace-nowrap">
            <Counter value={4200} suffix="+" />
          </div>
          <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-slate-400 mt-2.5 whitespace-nowrap">
            channels automated
          </span>
        </div>

        {/* Thin vertical line divider */}
        <div className="h-10 w-[1px] bg-white/[0.08] shrink-0" />
...
function TechnicalTrustMarquee() {
  ...
  return (
    <div className="relative z-10 w-full py-2.5 overflow-hidden bg-[#121212] border-t border-white/[0.04]">
...
export default function LandingPage({ onStartGenerating, onOpenAffiliate }: LandingPageProps) {
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = (e: MouseEvent) => {
      const userEmail = localStorage.getItem('userEmail') || localStorage.getItem('controlvid_user_email') || localStorage.getItem('viralflow_user_email');
      if (userEmail) {
  ...
  const handleExitIntentSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("controlvid_user_email", exitEmail);
  ...
  const workflowButtons = [
    ...
    },
    {
      ...
      glowClass: "shadow-[0_0_15px_rgba(59,130,246,0.06)] hover:shadow-[0_0_30px_rgba(59,130,246,0.35)]",
      borderColor: "border-[#3b82f6]/15 hover:border-[#3b82f6]/60",
      bgImage: "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=400&q=80"
    }
  ];
  ...
  return (
    <div 
      ...
      className={`relative bg-[#121212] text-slate-300 flex-1 flex flex-col font-sans overflow-x-hidden min-h-0 pt-0 mt-0 pb-0 mb-0 ${
    ...
    >
      ...
      <section id="hero-section" className="relative z-10 min-h-0 w-full px-4 sm:px-6 text-center flex flex-col items-center justify-start pt-0 pb-2 sm:pt-0 sm:pb-4 mt-0 mb-0">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center pt-0 pb-1 mt-0">
          {/* Social Proof Badge */}
          <div className="flex items-center space-x-2.5 mt-0 mb-2 px-4 py-1.5 sm:py-2 rounded-full bg-white/[0.03] border border-white/[0.06] shadow-md hover:border-white/[0.12] transition-colors">
            ...
            <span className="text-[14px] sm:text-[15.5px] font-semibold text-slate-200 tracking-wide font-sans">
              Trusted by <strong className="text-white font-black whitespace-nowrap inline-block">2,000+</strong> creators
            </span>
          </div>

          {/* Headline */}
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-[#38bdf8] tracking-tight uppercase leading-[1.15] max-w-4xl font-sans my-1">
          ...
          <p className="mt-2 mb-1 text-xs sm:text-sm md:text-base font-bold text-white max-w-3xl leading-relaxed font-sans">
            Your all-in-one AI engine: master Viral Shorts, Fake Text, POV, Split-screen, Social Viral Cloner, Full Long-form (2-10 min) Creation, Long-form to Auto-Clips, and E-commerce Ads. Scale 60-300 videos/credits per month, automate DM lead generation, schedule bulk content across Shadow Channels with one click, and track real-time analytics.
          </p>
        </div>

        {/* Bottom section of the viewport within hero container */}
        <div className="relative z-20 flex flex-col items-center justify-center px-4 mt-2">
          
          {/* Social Platforms Row (Arranged on a single clean line directly ABOVE the CTA button) */}
          <div className="mb-2 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 select-none">
          ...
          <div className="flex flex-col items-center">
            <button
              ...
              className="create-video-button px-8 sm:px-12 text-sm sm:text-base font-sans font-extrabold uppercase tracking-widest rounded-full cursor-pointer flex items-center justify-center space-x-3 active:scale-[0.98] group"
            >
              <span className="text-black font-extrabold font-sans">CREATE YOUR FIRST VIDEO</span>
              <Rocket className="h-5 w-5 sm:h-5.5 sm:w-5.5 text-black fill-current transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200" />
            </button>
            
            {/* Pure White subtle footer text */}
            <span className="mt-2 text-[11px] sm:text-xs font-semibold text-white tracking-wide font-sans select-none opacity-90">
      ...
      <section id="master-control-center" className="relative z-10 py-3 sm:py-6 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#121212]">
        ...
        <div className="py-2 w-full">
          <div 
            className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 w-full max-w-[700px] mx-auto px-1"
          >
            {workflowButtons.map((button) => {
              const IconComponent = button.icon;
              const isLongTitle = button.title.length > 14;
              return (
                <div 
                  key={button.id}
                  onClick={onStartGenerating}
                  ...
                  className="p-1.5 sm:p-2 relative group transition-all duration-300 cursor-pointer hover:-translate-y-0.5 hover:border-[#3b82f6]/80 hover:shadow-[0_0_12px_rgba(59,130,246,0.6)] aspect-[9/16] min-h-[190px] sm:min-h-[220px]"
                >
                  ...
                  <div 
                    ...
                    className="relative z-10 w-full min-w-0 px-0.5"
                  >
                    <div className="p-0.5 rounded bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
                      <IconComponent className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-[#38bdf8]" />
                    </div>
                    <h3 
                      style={{
                        lineHeight: "1.1",
                      ...
                      className={`${
                        isLongTitle 
                          ? "text-[7.5px] sm:text-[9px] md:text-[10px]" 
                          : "text-[8.5px] sm:text-[10px] md:text-[10.5px]"
                      } tracking-tight group-hover:text-[#38bdf8] transition-colors duration-200 whitespace-normal break-words shrink min-w-0 text-center`}
                    >
                      {button.title}
                    </h3>
                  </div>

                  {/* Dynamic AI Gallery Card Video Simulation */}
                  <div 
                    style={{
                      flexGrow: 1,
                      width: "100%",
      ...
      <section id="why-creators-choose-us" className="relative z-10 py-4 sm:py-8 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 bg-[#121212]">
        {/* Section Title */}
        <div className="text-center max-w-3xl mx-auto mb-4 sm:mb-8 flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-stretch font-sans">
          ...
          <div className="relative flex flex-col justify-between rounded-2xl bg-[#1E1E1E]/40 border border-white/[0.04] p-6 sm:p-8 transition-all duration-300 hover:border-white/[0.08]">
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-xs text-slate-400">
                ...
                <li className="flex items-start space-x-3">
                  <span className="text-slate-600 mt-0.5 select-none">—</span>
                  <span><strong>Social Viral Cloner:</strong> Editors cannot reliably deconstruct viral mechanics or duplicate retention structures.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-slate-600 mt-0.5 select-none">—</span>
          ...
          <div className="relative flex flex-col justify-between rounded-2xl bg-[#1E1E1E]/40 border border-white/[0.04] p-6 sm:p-8 transition-all duration-300 hover:border-white/[0.08]">
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-xs text-slate-400">
                ...
                <li className="flex items-start space-x-3">
                  <span className="text-slate-600 mt-0.5 select-none">—</span>
                  <span><strong>Social Viral Cloner:</strong> Hours spent manually analyzing and copying viral videos frame-by-frame.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-slate-600 mt-0.5 select-none">—</span>
          ...
          {/* Column 3: The Winner - ControlVid.ai */}
          <div 
            onClick={onStartGenerating}
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                ...
                <h3 className="text-lg font-black text-white uppercase tracking-tight font-sans">CONTROLVID</h3>
              ...
              <ul className="space-y-4 text-xs text-white">
                ...
                <li className="flex items-start space-x-3">
                  <span className="text-[#38bdf8] font-black mt-0.5 select-none text-sm leading-none">√</span>
                  <span className="font-semibold"><strong>Social Viral Cloner:</strong> Clone viral hooks, pacing, and structure from any URL instantly into multi-variations.</span>
                </li>
                <li className="flex items-start space-x-3">
                  <span className="text-[#38bdf8] font-black mt-0.5 select-none text-sm leading-none">√</span>
      ...
      {/* Footer Section */}
      <footer className="relative z-10 py-6 sm:py-8 border-t border-white/[0.05] bg-[#121212] text-center mt-4 sm:mt-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[11px] sm:text-xs text-white font-sans tracking-wide">
            © 2026 ControlVid All rights reserved.
          </p>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-[fadeIn_0.2s_ease-out]">
          <div className="relative w-full max-w-3xl bg-[#1a1a20] border border-white/10 rounded-2xl p-6 sm:p-10 shadow-2xl overflow-y-auto max-h-[85vh] text-left font-sans">
            ...
            <div className="mb-6 flex items-center space-x-3 border-b border-white/10 pb-4">
              ...
              <div>
                <h2 className="text-xl font-black text-white uppercase tracking-tight">ControlVid Partner Network Portal</h2>
            ...
            <div className="space-y-6 text-xs sm:text-sm text-neutral-300 leading-relaxed max-h-[55vh] overflow-y-auto pr-2">
              <section className="space-y-2">
                ...
                <p>
                  Earn <strong>50% recurring lifetime commissions</strong> for every active subscriber you refer to ControlVid.ai. Whether you are a content creator, agency owner, newsletter operator, or social media marketer, your earnings grow month after month as your referred creators scale their faceless video automation.
                </p>
              </section>
              ...
              <section className="space-y-2">
                ...
                <div className="p-4 rounded-xl bg-neutral-900 border border-white/10 space-y-3">
                  ...
                  <div className="p-3 rounded-lg bg-black text-[#38bdf8] font-mono text-xs font-bold truncate">
                    https://controlvid.ai/?aff={affiliateHandle || "partner"}
                  </div>
                  <button
                    onClick={() => {
                      const link = `https://controlvid.ai/?aff=${affiliateHandle || "partner"}`;
              ...
              <section className="space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-slate-400 text-xs">
                  ...
                  <li>Bidding on protected trademark terms (e.g. "ControlVid", "ControlVid.ai") via paid search ads is prohibited.</li>
          ...
          <div className="relative w-full max-w-3xl bg-[#242424] border border-white/10 rounded-2xl p-6 sm:p-10 shadow-2xl overflow-y-auto max-h-[85vh] text-left">
            ...
            <div className="space-y-6 font-sans text-xs sm:text-sm text-neutral-300 leading-relaxed max-h-[50vh] overflow-y-auto pr-2">
              <section className="space-y-2">
                ...
                <p>
                  Welcome to ControlVid.ai (the "Service", "Platform", "Software"). By accessing or using our automated faceless video generation and publishing tool, you agree to be bound by these Terms of Use. If you do not agree to these terms, please do not use the Service.
                </p>
              </section>
              ...
              <section className="space-y-2">
                ...
                <p>
                  You represent, warrant, and agree that you are solely and entirely responsible for all content, including but not limited to scripts, topics, visual templates, sound effects, voiceovers, and rendered videos generated or published through your account. ControlVid.ai operates solely as a passive software-as-a-service conduit. You must guarantee that any generated materials do not violate third-party intellectual property, privacy rights, local laws, global regulations, or the specific developer guidelines of YouTube, TikTok, and Instagram.
                </p>
              </section>
          ...
          <div className="relative w-full max-w-3xl bg-[#242424] border border-white/10 rounded-2xl p-6 sm:p-10 shadow-2xl overflow-y-auto max-h-[85vh] text-left">
            ...
            <div className="space-y-6 font-sans text-xs sm:text-sm text-neutral-300 leading-relaxed max-h-[50vh] overflow-y-auto pr-2">
              ...
              <section className="space-y-2">
                ...
                <p>
                  To deliver automation, ControlVid.ai safely routes encrypted video assets to official developer APIs (including YouTube Data API, TikTok Graph API, and Instagram Content Publishing API). By connecting your channels, you agree that your data is handled in strict compliance with each respective platform's privacy policy. Additionally, raw prompts and script messages are handled securely through enterprise Google GenAI APIs to prevent local leaks.
                </p>
              </section>
          ...
          <div className="relative w-full max-w-3xl bg-[#242424] border border-white/10 rounded-2xl p-6 sm:p-10 shadow-2xl overflow-y-auto max-h-[85vh] text-left">
            ...
            <div className="mb-8 flex items-center space-x-3 border-b border-white/5 pb-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-neutral-500 uppercase font-mono tracking-widest mt-0.5">ControlVid.ai Support & Knowledge Base</p>
              </div>
            </div>
                  ...
                  <div className="p-4 space-y-3 text-[11px]">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center space-x-2 text-[9px] font-bold text-white uppercase tracking-wider">
                        ...
                        <span>ControlVid Assistant</span>
                      </div>
...
function FAQAccordion() {
  ...
  const categories = {
    ...
    legal: {
      ...
      items: [
        {
          question: "Is my account safe when using ControlVid’s automation tools?",
        ...
        {
          question: "How does ControlVid handle user data and privacy?",
