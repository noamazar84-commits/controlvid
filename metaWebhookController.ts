...
export const ALL_TIERS: SubscriptionTier[] = [
  {
    ...
    price: 49,
    annualPrice: 44,
    credits: "70 Credits/video/minutes",
    shadowChannelsCount: 3,
    shadowChannelsLabel: "3 Shadow Channels",
    analyticsLabel: "Basic Analytics: Video Views Tracking",
    supportLabel: "Self-service support",
    features: [
      "70 Credits/video/minutes limit",
      "3 Shadow Channels broadcasters",
  ...
  },
  {
    ...
    price: 89,
    annualPrice: 80,
    credits: "130 Credits/video/minutes",
    ...
    features: [
      "130 Credits/video/minutes limit",
  ...
  },
  {
    ...
    price: 129,
    annualPrice: 115,
    credits: "200 Credits/video/minutes",
    ...
    features: [
      "200 Credits/video/minutes limit",
  ...
  },
  {
    ...
    price: 229,
    annualPrice: 208,
    credits: "310 Credits/video/minutes",
    ...
    features: [
      "310 Credits/video/minutes limit",
...
export default function SubscriptionBillingWorkspace({
  ...
  // Default to Spark tier ($49/mo, 60 credits limit) unless explicitly matching another tier
  ...
  ) || ALL_TIERS[0]; // Default Spark ($49)

  const planTier = activeTierObj.name;
  const userEmail = activeUser?.email || "creator@controlvid.ai";
