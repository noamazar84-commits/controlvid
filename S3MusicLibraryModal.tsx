...
export default function CustomMode({ onBack, onSuccess, modeType, isLoggedIn, onNavigatePricing, activeUser }: CustomModeProps) {
  ...
  const [voiceModel, setVoiceModel] = useState<string>('Adam (Authoritative Executive)');
          ...
          <div className="magic-settings-container" style={{ 
            ...
            {modeType === "long_form_clips" ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                ...
                <div className="custom-form-grid" style={{
                  display: 'grid',
                  ...
                  gap: '15px'
                    ...
                    <div>
                      ...
                      <VoiceTalentDropdown
                        ...
                        niche={customTopic || videoFramework}
                        buttonHeight="38px"
                      />
                    </div>
                  ...
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '6px', fontSize: '11px', fontWeight: 'bold', color: '#888', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>
                ...
                {/* Caption Style (ControlVid Vibe) - Full Width */}
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '11px', fontWeight: 'bold', color: '#888', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>
                    <Sparkles size={12} style={{ color: '#38bdf8' }} />
                ...
                <div>
                  ...
                  <div className="custom-platform-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                    {[
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                ...
                <div style={{ background: '#1a1a1a', border: '1px solid #333', borderRadius: '10px', overflow: 'hidden' }}>
                  ...
                  {isVideoStyleOpen && (
                    <div className="custom-video-style-grid" style={{ padding: '12px', borderTop: '1px solid #2a2a2a', background: '#111', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px' }}>
            ...
            >
              <span>{modeType === "long_form_clips" ? `EXTRACT AUTO-CLIPS WITH AI (${formatCreditText(modeType, 60, 1)})` : `Generate AI Video (${formatCreditText("custom", 60, 1)})`}</span>
              <Sparkles size={16} />
            </button>
